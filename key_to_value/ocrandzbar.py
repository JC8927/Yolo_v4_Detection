...
#     codes=decode(img)
#     barcode_infor_list=key_to_value.barcode_data_preprocess(codes)
#     all_barcode_list.append(barcode_infor_list)
...
for i in range(img_num):
    config=None
    config_path=result_img_path+"config.json"
    ...
    if config==None:
        result_list,match_text_list=key_to_value.first_compare(imformation_list,result_img_path)
    else:
