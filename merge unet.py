...
#train完的model 在此reload config
# 建立reload_model 並且讀取訓練好的權重
# 預設load最新model
...
plt.imshow(cv2.imread("./result_dir/"+img_name[0]))

start=time.time()#計時

mask_img_path="./process/mask_img/"
ori_img_path="./process/ori_img/"
result_img_path="./process/result_img/"
ocr_img_path="./process/ocr_img/"
noresize_ocr_img_path="./process/noresize_ocr_img/"
...
#     im_show = draw_ocr(image, boxes, txts, scores)
    ...
    im_show.save("./process/crap_sha_result/"+img_name[i])
end=time.time()
